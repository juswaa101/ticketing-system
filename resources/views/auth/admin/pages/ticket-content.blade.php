...
@include('components.modals.admin.tickets.add-ticket-modal')
@include('components.modals.admin.tickets.edit-ticket-modal')
@include('components.modals.admin.tickets.view-ticket-modal')
@include('components.modals.admin.comments.view-comments')
...
<script>
    $(function() {
        ...
        $(document).on('click', '.edit-ticket', function(e) {
            ...
            let url = "{{ route('admin-tickets.edit', ':id') }}";
        ...
        $(document).on('click', '.editTicketBtn', function(e) {
            ...
            let url = "{{ route('admin-tickets.update', ':id') }}";
        ...
        $(document).on('click', '.view-ticket', function(e) {
            ...
            let url = "{{ route('admin-tickets.show', ':id') }}";
            url = url.replace(':id', $(this).attr('data-val'));
            $.ajax({
                type: "get",
                url: url,
        ...
        $(document).on('click', '.delete-ticket', function(e) {
            let url = "{{ route('admin-tickets.destroy', ':id') }}";
            url = url.replace(':id', $(this).attr('data-val'));
            Swal.fire({
                title: 'Are you sure?',
